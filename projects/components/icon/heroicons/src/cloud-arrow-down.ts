...
/** Heroicons 24/outline/cloud-arrow-down */
export const cloudArrowDownOutline: WiIconGlyph = {
  viewBox: '0 0 24 24',
  nodes: [
    {
      tag: 'path',
...
/** Heroicons 24/solid/cloud-arrow-down */
export const cloudArrowDownSolid: WiIconGlyph = {
  viewBox: '0 0 24 24',
  nodes: [
    {
      tag: 'path',
