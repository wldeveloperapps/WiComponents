...
| Capacidad Wi (objetivo) | Origen Prime (referencia) | Dominio                     | Cubo     | Estado   | Notas                                                                                                                                                                                                                            |
| ----------------------- | ------------------------- | --------------------------- | -------- | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Table                   | `table`                   | `data-display`              | base     | done     | `@wiloc/ui/data-display` (`wi-table`): sort, filtros, page, visibility, row actions; compacto automático <960px; chevron/tarjeta si hay columnas extra (`priority` default `collapse`; `always` se queda en la fila); `compact` override. Reorder → futuro |
