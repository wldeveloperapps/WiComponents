...
- overlays anclados dentro de `overflow: auto` (select/menú cierran al scroll; datepicker sigue al trigger)
...
Arranca `ng serve` y comprueba: select/menú/filtro **cierran** al hacer scroll dentro del recuadro de 300px; el datepicker **sigue** al trigger. La primera vez descarga Chromium (`playwright install chromium`).
